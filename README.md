<div align="center">
	...
	<br></br>
	<img src="https://estruyf-github.azurewebsites.net/api/VisitorHit?user=dde-fite&repo=madushadhanushka&countColorcountColor&countColor=%238a2be2" alt="Views Counter">
	...
	<table align="center">
		<tr border="none">
			<td width="50%" align="center">
				<img alt="Nora's github stats" align="center"  src="https://github-readme-stats-three-iota-14.vercel.app/api?username=dde-fite&show_icons=true&count_private=true&hide_border=true&title_color=8a2be2&icon_color=8a2be2&text_color=414b61&bg_color=fffff" />
				<br></br>
...
### Common Core
| Project | Score | Time Spent | Description |
|-------|-------|------------|-------------|
| [Libft](https://github.com/dde-fite/42_libft) | ![125/100](https://img.shields.io/badge/score-125%2F100-8a2be2) | ![](https://codestats.cloud.defitero.com/api/badge/nora.defitero/interval:any/project:42_libft) | My own C standard library |
| [ft_printf](https://github.com/dde-fite/42_ft_printf) | ![125/100](https://img.shields.io/badge/score-125%2F100-8a2be2) | ![](https://codestats.cloud.defitero.com/api/badge/nora.defitero/interval:any/project:42_ft_printf) | Recreation of printf |
...
| Project | Description |
|---------|-------------|
| [Mlx_Python_Game_Engine](https://github.com/dde-fite/Mlx_Python_Game_Engine) | Python game engine built on top of MiniLibX |
| [42_MiniLibX_Python_Manual](https://github.com/dde-fite/42_MiniLibX_Python_Manual) | Python manual for MiniLibX graphics library |
| [42_libft_tester](https://github.com/dde-fite/42_libft_tester) | Automated testing framework for Libft projects |
<!-- My journey in 42 -->
